...
if (typeof userInput === "string"
    ...
    && userInput.includes("!")
    && userInput.includes(" ")
    && userInput.includes(",")) { // Type check to ensure userInput is a non-empty string
    console.log(userInput); // Output: Hello, World!
}
let additionalInput = "ABCDEF 12345 &*^%$#@!";
if (typeof additionalInput === "string"
    ...
    && additionalInput.includes("&*^%$#@!")) { // Type check to ensure additionalInput is a non-empty string with specific content
