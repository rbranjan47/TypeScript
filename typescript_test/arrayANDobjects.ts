...
let hobbies: string[] = ["Working", "Biking", "Cooking", "Gym", "Reading"];
...
let anyArray: any[] = ["Hello", 42, true, { name: "Alice" }, [1, 2, 3]];
...
let persons: { name: string, age: number, contact: number | string, address: any }[] = [
...
let myVariable: string | null = null; // This variable can be a string or null
...
let anotherVariable: number | undefined; // This variable can be a number or undefined
