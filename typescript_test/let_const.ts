...
let myVariable: number = 10; // Declare a variable using let and assign a value
...
const myConstant: string = "Hello, TypeScript!"; // Declare a constant variable and assign a value
